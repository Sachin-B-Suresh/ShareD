            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                    if(!loggedInUserEmail.equals(snapshot.child("RequesterEmail").getValue().toString())){
                        ...
                        accepter_array.add(snapshot.child("AccepterEmail").getValue().toString());
        ...
        public void onBindViewHolder(@NonNull RecyclerViewHolder holder, final int position) {
            ...
            holder.cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    cardViewOnClick(position,requests_child_key.get(position),status_array.get(position));
                }
            });
        }
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which){
                    case DialogInterface.BUTTON_POSITIVE:
                        Toast.makeText(getActivity(), childKey, Toast.LENGTH_SHORT).show();
